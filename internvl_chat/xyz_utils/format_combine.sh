...
#     --language ${language} \
#     --caption_json xyz_data/${language}/trans_${language}.json \
#     --image_jsonl xyz_data/vi/image_release_v2_vi_image_pure_json_in_part-671a151ef417-000000.jsonl \
#     --image_save_path ${image_save_path} \
#     --save_path  ${save_path}\
#     --data_length 90000
...
#     --language ${language} \
#     --prompt_path xyz_utils/prompt.json \
#     --save_path ${save_path} \InternVL/internvl_chat/xyz_data/th/image_release_v2_th_image_pure_json_in_part-671b228af112-000000.jsonl
#     --image_save_path ${image_save_path} \
#     --data_length 90000
...
#     --language ${language} \
#     --caption_json xyz_data/${language}/trans_${language}.json \
#     --image_jsonl xyz_data/ko/image_release_v2_ko_image_pure_json_in_part-671b1a0159e6-000000.jsonl \
#     --image_save_path ${image_save_path} \
#     --save_path  ${save_path}\
#     --data_length 90000
